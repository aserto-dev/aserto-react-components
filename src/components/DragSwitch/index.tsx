...
export const DragSwitch = ({
  ...
  const onMouseUp = (e: MouseEvent) => {
    ...
    if (switchRef.current && dragging) {
      const mouseRelativePos = e.clientX - switchRef.current.getBoundingClientRect().left
  ...
  const onMouseMove = (e: MouseEvent) => {
    ...
    if (switchRef.current && dragging) {
      const halfHandle = 8
      const newPos = e.clientX - switchRef.current.getBoundingClientRect().left - halfHandle
