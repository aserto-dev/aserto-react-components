...
})(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 100%;\n  min-width: 320px;\n  max-height: 102px;\n  display: flex;\n  align-items: center;\n  padding: 8px 10px;\n  background-color: ", ";\n  border: 1px solid ", ";\n  background-size: cover;\n  &:hover {\n    background-color: ", ";\n    cursor: pointer;\n  }\n"], ["\n  width: 100%;\n  min-width: 320px;\n  max-height: 102px;\n  display: flex;\n  align-items: center;\n  padding: 8px 10px;\n  background-color: ", ";\n  border: 1px solid ", ";\n  background-size: cover;\n  &:hover {\n    background-color: ", ";\n    cursor: pointer;\n  }\n"])), theme.primaryBlack, theme.grey30, theme.grey10);
var CardTitle = Ye.div.withConfig({
  displayName: "UserCard__CardTitle",
...
var UserCard = function UserCard(_a) {
  ...
  return /*#__PURE__*/React.createElement(CardContainer, __assign({
    onClick: onClick
  }, props), /*#__PURE__*/React.createElement(CardImageContainer, null, /*#__PURE__*/React.createElement("img", {
    src: user.picture || img,
    alt: "picture"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CardTitle, null, user.display_name), /*#__PURE__*/React.createElement(CardText, null, user.email)));
};
