...
var CardImageContainer = styled__default['default'].div.withConfig({
...
var UserCard = function UserCard(_a) {
  var user = _a.user,
      ...
      testId = _a.testId,
      props = _tslib.__rest(_a, ["user", "onClick", "disabled", "testId"]);

  return /*#__PURE__*/React__default['default'].createElement(CardContainer, _tslib.__assign({}, utils.mapTestIdToProps(testId), {
    onClick: onClick
  }, props, {
    "$disabled": disabled
  }), /*#__PURE__*/React__default['default'].createElement(CardImageContainer, null, /*#__PURE__*/React__default['default'].createElement("img", {
    src: user.picture || img,
    alt: "picture"
  })), /*#__PURE__*/React__default['default'].createElement(CardContent, null, /*#__PURE__*/React__default['default'].createElement(CardText, {
    "$bold": true
  }, user.display_name), /*#__PURE__*/React__default['default'].createElement(CardText, null, user.email)));
};
