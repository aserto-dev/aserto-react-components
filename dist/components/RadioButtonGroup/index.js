...
var RadioButton = Ye.div.withConfig({
  ...
  return $disabled ? _e(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n          background-color: ", ";\n          border: 1px solid ", ";\n        "], ["\n          background-color: ", ";\n          border: 1px solid ", ";\n        "])), theme.grey10, theme.grey30) : '';
}, function (_a) {
  var $selected = _a.$selected,
      $disabled = _a.$disabled;
  var color = $disabled ? theme.lochivar30 : theme.lochivar100;
  return $selected ? _e(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          border: 1px solid ", ";\n          &:after {\n            background: ", ";\n            width: 11px;\n            height: 11px;\n            display: flex;\n            margin: auto;\n            border-radius: 10px;\n            content: '';\n          }\n        "], ["\n          border: 1px solid ", ";\n          &:after {\n            background: ", ";\n            width: 11px;\n            height: 11px;\n            display: flex;\n            margin: auto;\n            border-radius: 10px;\n            content: '';\n          }\n        "])), color, color) : "border: 1px solid " + theme.grey50 + ";";
});
...
var RadioButtonGroup = function RadioButtonGroup(_a) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, label && /*#__PURE__*/React.createElement(Label, null, label), /*#__PURE__*/React.createElement(RadioGroupContainer, null, options.map(function (option) {
