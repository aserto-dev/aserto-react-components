...
var TableContainer = styled__default['default'].div.withConfig({
...
var Table = styled__default['default'].table.withConfig({
  displayName: "DataTable__Table",
  componentId: "cnajix-2"
})(templateObject_3 || (templateObject_3 = _tslib.__makeTemplateObject(["\n  background-color: ", ";\n  width: 100%;\n  thead {\n    tr {\n      color: ", ";\n      font-weight: bold;\n      font-size: 16px;\n      th {\n        min-width: 120px;\n        padding: 20px;\n      }\n    }\n  }\n  tbody {\n    font-size: 14px;\n    tr {\n      color: ", ";\n      border: 1px solid ", ";\n      td {\n        border-bottom: 1px solid ", ";\n        padding: 20px;\n      }\n    }\n  }\n"], ["\n  background-color: ", ";\n  width: 100%;\n  thead {\n    tr {\n      color: ", ";\n      font-weight: bold;\n      font-size: 16px;\n      th {\n        min-width: 120px;\n        padding: 20px;\n      }\n    }\n  }\n  tbody {\n    font-size: 14px;\n    tr {\n      color: ", ";\n      border: 1px solid ", ";\n      td {\n        border-bottom: 1px solid ", ";\n        padding: 20px;\n      }\n    }\n  }\n"])), theme.theme.primaryBlack, theme.theme.grey100, theme.theme.grey70, theme.theme.grey20, theme.theme.grey20);
var DataTable = function DataTable(_a) {
  var data = _a.data,
      columns = _a.columns;

  var _b = reactTable.useTable({
    columns: columns,
    data: data
  ...
  return /*#__PURE__*/React__default['default'].createElement(TableContainer, null, /*#__PURE__*/React__default['default'].createElement(Table, _tslib.__assign({}, getTableProps()), /*#__PURE__*/React__default['default'].createElement("thead", null, headerGroups.map(function (headerGroup) {
    return /*#__PURE__*/React__default['default'].createElement("tr", _tslib.__assign({}, headerGroup.getHeaderGroupProps()), headerGroup.headers.map(function (column) {
      var _a;

      return /*#__PURE__*/React__default['default'].createElement("th", _tslib.__assign({}, column.getHeaderProps(column.getSortByToggleProps()), {
        style: (_a = column.style) === null || _a === void 0 ? void 0 : _a.headerCell
      }), column.render('Header'), /*#__PURE__*/React__default['default'].createElement("span", null, column.isSorted ? column.isSortedDesc ? /*#__PURE__*/React__default['default'].createElement(Icon, {
        src: img
      }) : /*#__PURE__*/React__default['default'].createElement(Icon, {
        src: img$1
      }) : ''));
    }));
  })), /*#__PURE__*/React__default['default'].createElement("tbody", _tslib.__assign({}, getTableBodyProps()), firstPageRows.map(function (row, i) {
    prepareRow(row);
    return /*#__PURE__*/React__default['default'].createElement("tr", _tslib.__assign({}, row.getRowProps()), row.cells.map(function (cell) {
      var _a, _b;

      return /*#__PURE__*/React__default['default'].createElement("td", _tslib.__assign({}, cell.getCellProps(), {
