import { _ as __makeTemplateObject, b as __assign } from '../../_tslib-66d5e02f.js';
...
var DataTable = function DataTable(_a) {
  var data = _a.data,
      columns = _a.columns,
      renderRowSubComponent = _a.renderRowSubComponent,
  ...
  var _b = useTable({
    ...
    expandSubRows: false
      ...
      visibleColumns = _b.visibleColumns;

  return /*#__PURE__*/React.createElement(TableContainer, null, /*#__PURE__*/React.createElement(Table, __assign({
    "$hasSubRow": renderRowSubComponent !== undefined
    ...
    prepareRow(row);
    var shouldShowSubRow = renderRowSubComponent !== undefined && row.isExpanded;
    var Tr = rowComponent || RowComponent;
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tr, __assign({
      isExpanded: row.isExpanded
    }, row.getRowProps()), row.cells.map(function (cell) {
      var _a, _b;

      var customCellProps = getCellProps ? getCellProps(cell) : {};
      return /*#__PURE__*/React.createElement("td", __assign({}, cell.getCellProps(), customCellProps, {
