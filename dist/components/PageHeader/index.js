...
var PageHeaderContainer = styled.div.withConfig({
...
var PageHeader = function PageHeader(_a) {
  ...
  return /*#__PURE__*/React.createElement(PageHeaderContainer, __assign({
    ...
    load: load,
    loading: loading
  }), /*#__PURE__*/React.createElement("div", null, title && /*#__PURE__*/React.createElement(PageTitle, {
    title: title
  }), subtitle && /*#__PURE__*/React.createElement("div", null, subtitle)), children);
};
