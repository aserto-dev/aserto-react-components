...
var SelectWithoutControl = /*#__PURE__*/React.forwardRef(function (_a, ref) {
  var options = _a.options,
      ...
      removeTenantText = _a.removeTenantText,
      _onBlur = _a.onBlur,
      props = __rest(_a, ["options", "defaultValue", "onChange", "label", "disabled", "style", "value", "disableLabel", "name", "onClickRemoveTenant", "onClickSave", "onClickCancel", "shouldDisableOptions", "removeTenantText", "onBlur"]);
  ...
  var _c = useState(null),
      firstSelectedOption = _c[0],
      setFirstSelectedOption = _c[1];
  ...
  var CustomMenu = useCallback(function (_a) {
    ...
    }, removeTenantText || 'Remove member from tenant'), /*#__PURE__*/React.createElement("div", {
