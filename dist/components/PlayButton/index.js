...
var PlayButtonContainer = styled__default['default'].div.withConfig({
  displayName: "PlayButton__PlayButtonContainer",
  componentId: "tp1yjt-0"
})(templateObject_1 || (templateObject_1 = _tslib.__makeTemplateObject(["\n  width: 42px;\n  height: 42px;\n  fill: ", ";\n  &:hover {\n    fill: ", ";\n  }\n"], ["\n  width: 42px;\n  height: 42px;\n  fill: ", ";\n  &:hover {\n    fill: ", ";\n  }\n"])), theme.theme.lochivarAccent3, theme.theme.lochivarAccent1);
var PlayButton = function PlayButton(_a) {
  var onClick = _a.onClick,
      props = _tslib.__rest(_a, ["onClick"]);

  return /*#__PURE__*/React__default['default'].createElement(PlayButtonContainer, _tslib.__assign({
    onClick: onClick
