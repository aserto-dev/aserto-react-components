...
var components_TooltipDialog_index = require('../TooltipDialog/index.js');
...
var ErrorMessage = styled__default['default'].div.withConfig({
...
var WorkingSpinnerContainer = styled__default['default'].div.withConfig({
...
var PolicyCard = function PolicyCard(_a) {
  var name = _a.name,
      ...
      errors = _a.errors,
      props = _tslib.__rest(_a, ["name", "repoUrl", "onClick", "onClickRemoveIcon", "testId", "disabled", "policyIconVariant", "errors"]);

  var getAppIconBasedOnIconVariant = React.useCallback(function () {
    var obj = {
      pending: img$3,
      error: img$2,
      loaded: img$4
  ...
  var formatErrorsToDisplay = function formatErrorsToDisplay() {
    return /*#__PURE__*/React__default['default'].createElement("div", null, errors.map(function (error) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(PolicyCardContainer, _tslib.__assign({}, utils.mapTestIdToProps(testId), props, {
    disabled: disabled
  }), /*#__PURE__*/React__default['default'].createElement(CardContent, _tslib.__assign({
    onClick: onClickContent
  }, utils.mapTestIdToProps(testId + "-content")), /*#__PURE__*/React__default['default'].createElement(CardImg, {
    src: getAppIconBasedOnIconVariant(),
    alt: "application"
  }), shouldDisplayPolicyErrorOverlay && /*#__PURE__*/React__default['default'].createElement(Tooltip__default['default'], {
    component: components_TooltipDialog_index.TooltipDialog,
    position: "top",
    content: formatErrorsToDisplay
  }, /*#__PURE__*/React__default['default'].createElement(ErrorMessage, null, "Error")), policyIconVariant === 'pending' && /*#__PURE__*/React__default['default'].createElement(WorkingSpinnerContainer, null, /*#__PURE__*/React__default['default'].createElement("img", {
    src: img,
    alt: "working-spinner"
  }), /*#__PURE__*/React__default['default'].createElement("div", null, " Pending... ")), /*#__PURE__*/React__default['default'].createElement(TextContainer, null, /*#__PURE__*/React__default['default'].createElement(CardText, {
    bold: true
  }, name), repoUrl && /*#__PURE__*/React__default['default'].createElement(CardText, null, repoUrl))), onClickRemoveIcon && /*#__PURE__*/React__default['default'].createElement(Icon, _tslib.__assign({}, utils.mapTestIdToProps(testId + "-remove-btn"), {
