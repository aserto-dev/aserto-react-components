...
var Anm = styled.keyframes(templateObject_1 || (templateObject_1 = _tslib.__makeTemplateObject(["\n  0% {\n    opacity: 0;\n    transform: translateY(-100%);\n  }\n\n  10% {\n    transform: translateY(-100%);\n  }\n\n  15% {\n    transform: translateY(0);\n  }\n\n  30% {\n    transform: translateY(-10%);\n  }\n\n  40% {\n    transform: translateY(0%);\n  }\n\n  100% {\n    opacity: 1;\n  }\n"], ["\n  0% {\n    opacity: 0;\n    transform: translateY(-100%);\n  }\n\n  10% {\n    transform: translateY(-100%);\n  }\n\n  15% {\n    transform: translateY(0);\n  }\n\n  30% {\n    transform: translateY(-10%);\n  }\n\n  40% {\n    transform: translateY(0%);\n  }\n\n  100% {\n    opacity: 1;\n  }\n"])));
var ActionableInputContainer = styled__default['default'].div.withConfig({
...
var ButtonContainer = styled__default['default'](components_Button_index.Button).withConfig({
  ...
  return $wasClicked ? styled.css(templateObject_3 || (templateObject_3 = _tslib.__makeTemplateObject(["\n          animation: ", " 0.6s 0.1s 1 linear alternate;\n          background-color: transparent !important;\n        "], ["\n          animation: ", " 0.6s 0.1s 1 linear alternate;\n          background-color: transparent !important;\n        "])), Anm) : '';
});
var ActionableInput = function ActionableInput(_a) {
  var onClickCopy = _a.onClickCopy,
      ...
      testId = _a.testId,
      inputProps = _tslib.__rest(_a, ["onClickCopy", "shouldShowHideShowButton", "testId"]);

  var _b = React.useState(inputProps.type || 'text'),
      type = _b[0],
      setType = _b[1];
  ...
  return /*#__PURE__*/React__default['default'].createElement(ActionableInputContainer, null, /*#__PURE__*/React__default['default'].createElement(components_Input_index.Input, _tslib.__assign({}, inputProps, {
    type: type,
    "data-testid": testId
  })), onClickCopy && /*#__PURE__*/React__default['default'].createElement(ButtonContainer, _tslib.__assign({
  ...
  }, utils.mapTestIdToProps(testId + "-copy-btn")), /*#__PURE__*/React__default['default'].createElement("img", {
    src: img,
    alt: "copy"
  })), shouldShowHideShowButton && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, type === 'password' ? /*#__PURE__*/React__default['default'].createElement(components_Button_index.Button, _tslib.__assign({
    variant: "secondary-borderless",
    onClick: function onClick() {
      return setType('text');
    }
  }, utils.mapTestIdToProps(testId + "-show-btn")), /*#__PURE__*/React__default['default'].createElement("img", {
    alt: "show",
    src: img$2
  })) : /*#__PURE__*/React__default['default'].createElement(components_Button_index.Button, _tslib.__assign({
    onClick: function onClick() {
      return setType('password');
    },
    variant: "secondary-borderless"
  }, utils.mapTestIdToProps(testId + "-hide-btn")), /*#__PURE__*/React__default['default'].createElement("img", {
    alt: "hide",
    src: img$1
  }))));
};
...
exports.ActionableInput = ActionableInput;
